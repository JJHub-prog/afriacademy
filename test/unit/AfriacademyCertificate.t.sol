...
contract AfriacademyRegistryTest is Test {
    ...
    event CourseCreated(uint256 indexed courseId, string name, uint256 duration);
    event CourseEnrollment(address indexed student, uint256 indexed courseId);
    event ProgressUpdated(address indexed student, uint256 indexed courseId, uint256 progress);
    event ExamResultRecorded(address indexed student, uint256 indexed courseId, uint256 score, bool passed);
    ...
    function testStudentRegistration() public {
        ...
        // Verify registration
        (string memory name, bool isRegistered, , ) = registry.getStudent(student1);
    ...
    function testCourseCreation() public {
        ...
        (string memory name, uint256 duration, uint256 requiredScore, bool isActive) = registry.getCourse(1);
    ...
    function testAccessControl() public {
        ...
        vm.prank(student1);
        vm.expectRevert("AccessControl: account 0x0000000000000000000000000000000000000003 is missing role 0x91b59cd25b3ffe6578b30ee4914fdc05b48f0ace322e68702c939db26f48696e");
