...
contract AfriacademyCertificateTest is Test {
    ...
    function testCannotMintDuplicateCertificate() public {
        ...
        vm.prank(minter);
        vm.expectRevert(AfriacademyCertificate.CertificateAlreadyIssued.selector);
    ...
    function testAccessControl() public {
        ...
        vm.prank(student1);
        vm.expectRevert("AccessControl: account 0x0000000000000000000000000000000000000003 is missing role 0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6");
        certificate.mintCertificate(student1, 1, "ipfs://QmTest");
    ...
    function testPauseFunctionality() public {
        ...
        vm.prank(minter);
        uint256 tokenId = certificate.mintCertificate(student1, 1, "ipfs://QmTest");
        assertEq(tokenId, 1);
    }
